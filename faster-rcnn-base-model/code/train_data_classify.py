...
np.save('../prior/new/chair_new',chair)
np.save('../prior/new/wrongchair_new',wrongchair)
np.save('../prior/new/table_new',table)
np.save('../prior/new/wrongtable_new',wrongtable)

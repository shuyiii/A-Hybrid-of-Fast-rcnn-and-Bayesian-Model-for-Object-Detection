...
import os
import pandas as pd
path='/fs/project/PAS1263/src/models/research/object_detection/chairtable/get_bounding_box/Bndbox/chair_table_new_train/'
gtpath='/fs/project/PAS1263/data/ILSVRC/train.csv'
chair=[];
table=[];
wrongchair=[];
wrongtable=[];
       ...
       if data.ndim!=1:
                for i in range(0,300):
                    for j in range(0,data.shape[0]):
                         ...
                         if intersection_over_union(boxA, boxB)>0.5 and prob[i]>0.005:
...
np.save('../prior/new/sizechair_new',chair)
np.save('../prior/new/sizetable_new',table)
np.save('../prior/new/wrongsizechair_new',wrongchair)
np.save('../prior/new/wrongsizetable_new',wrongtable)
